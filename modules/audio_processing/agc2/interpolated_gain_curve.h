...
class InterpolatedGainCurve {
 ...
 private:
  ...
  static constexpr float approximation_params_x_[kInterpolatedGainCurveTotalPoints] 
  ...
  RTC_VIEW(float) approximation_params_x_view_;
  static constexpr float approximation_params_m_[kInterpolatedGainCurveTotalPoints] 
  ...
  RTC_VIEW(float) approximation_params_m_view_;
  static constexpr float approximation_params_q_[kInterpolatedGainCurveTotalPoints] 
  ...
  RTC_VIEW(float) approximation_params_q_view_;
