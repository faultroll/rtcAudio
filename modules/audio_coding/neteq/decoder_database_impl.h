...
#ifndef WEBRTC_MODULES_AUDIO_CODING_NETEQ_DECODER_DATABASE_IMPL_H_
#define WEBRTC_MODULES_AUDIO_CODING_NETEQ_DECODER_DATABASE_IMPL_H_
...
class DecoderDatabaseImpl final : public DecoderDatabase {
 public:
 ...
 private:
  ...
  RTC_DISALLOW_COPY_AND_ASSIGN(DecoderDatabaseImpl);
};

}  // namespace webrtc
#endif  // WEBRTC_MODULES_AUDIO_CODING_NETEQ_DECODER_DATABASE_IMPL_H_
